import { CurrencyAmount, JSBI, Token, Trade } from 'richsdk'
...
export default function Swap() {
  ...
  const setUpCanvas = () => {
    ...
    const material = new THREE.MeshBasicMaterial({ color: 'yellow', envMap: textureCube })
    ...
    //**Canvas**
    const canvas: any | null = document.getElementById('webgl')
    ...
    if (renderer) setIsModelLoading(false)
